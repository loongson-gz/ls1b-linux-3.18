...
#define PCA9554_GPIO_BASE 212
#define PCA9554_IRQ_BASE 212

static int pca9554_setup(struct i2c_client *client, unsigned gpio,
				unsigned int ngpio, void *context)
{
	//把PS_ON设置为高电平，使能系统电源
...
static struct pca953x_platform_data i2c_pca9554_platdata = {
	.gpio_base	= PCA9554_GPIO_BASE, /* Start directly after the CPU's GPIO */
	.irq_base = PCA9554_IRQ_BASE,
//	.invert		= 0, /* Do not invert */
	.setup		= pca9554_setup,
};
...
static struct i2c_board_info ls1x_i2c0_board_info[] = {
	...
	},
	{
		...
		.irq = TCA6424_IRQ_BASE + 18,
		.platform_data = &i2c_pca9554_platdata,
	},
#endif
#ifdef CONFIG_TOUCHSCREEN_GOODIX
	{
